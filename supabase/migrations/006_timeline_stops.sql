...
(9, 'sat', '12:00', 'Lunch — Sizzle & Crunch (Bellevue)', 'Vietnamese fast-casual right by Meydenbauer — banh mi, vermicelli bowls, rice plates. ~5 min walk from the venue. Quick service that fits the lunch break.', '10438 NE 10th St, Bellevue, WA 98004', 'https://maps.app.goo.gl/vEBRvnJ8wkT8PeFXA', NULL, '[]', 9),
...
(33, 'sun', '12:30', 'Pike Place Market & Seattle Waterfront', E'Park at the Pike Place Market PDA Garage — safe, well-lit, with elevators straight up to MarketFront and the new Overlook Walk down to the waterfront. Walk Pike Place itself, then take the Overlook Walk down. We split into smaller groups: Alex & Edgar group · Gaby group · adults. Anyone who wants to check out Miner\'s Landing on Pier 57 (the Great Wheel and arcades) can — just stay with your group and stay in touch. ~2h 15m of free exploring.', '1531 Western Ave, Seattle, WA 98101 (Pike Place Market PDA Garage)', 'https://www.google.com/maps/search/?api=1&query=Pike+Place+Market+PDA+Garage+1531+Western+Ave', NULL, '[]', 33),
(34, 'sun', '14:45', 'Group photo — Seattle waterfront', 'All three groups meet up at Pier 62 / the Overlook Walk plaza for a group photo before we head to lunch.', NULL, NULL, NULL, '[]', 34),
(35, 'sun', '15:00', 'Late lunch — Din Tai Fung (Pacific Place)', 'Famous Taiwanese soup dumplings. ~5 min drive from the Pike Place garage to the Pacific Place Garage — direct elevator up to Din Tai Fung on level 4. Easy parking, easy departure for the drive home.', '600 Pine St #403, Seattle, WA 98101', 'https://maps.app.goo.gl/FNhqBYUW2U8sxFwH8', NULL, '[]', 35),
(36, 'sun', '16:15', 'Depart for Yakima', 'I-5 S → I-90 E → I-82 E → US-12 E. ~2h 30m from downtown Seattle.', NULL, NULL, NULL, '[]', 36),
