...
(function () {
  ...
  const STOPS = [
    ...
    { id: 18, day: 'sat', time: '20:30',
      ...
      body:  'The group will pick a spot together. Here are some options near the hotel — but feel free to change your mind once you\'re there.',
      places: [
        { name: 'The Cheesecake Factory', desc: 'American', walk: '~5 min drive', url: 'https://maps.app.goo.gl/RpB6U2LrafuNnGh86' },
        { name: 'Applebee\'s Grill + Bar', desc: 'American grill', walk: '~3 min drive', url: 'https://maps.app.goo.gl/LKWSGDRm8j645Wmk8' },
        { name: 'P.F. Chang\'s', desc: 'Chinese & Asian', walk: '~5 min drive', url: 'https://www.google.com/maps?cid=15890116548250234931' },
        { name: 'Kura Revolving Sushi Bar', desc: 'Japanese sushi', walk: '~5 min drive', url: 'https://www.google.com/maps/search/?api=1&query=Kura+Revolving+Sushi+Bar+3321+184th+St+SW+Lynnwood+WA' },
        { name: 'Shake Shack', desc: 'Burgers & shakes', walk: '~3 min drive', url: 'https://maps.app.goo.gl/4uFhM9PgnQrzDMaC9' },
        { name: 'Chick-fil-A', desc: 'Chicken', walk: '~3 min drive', url: 'https://maps.app.goo.gl/vyADsDpkJ2C2qX1d6' },
      ],
  ...
  const PROFILE_ICONS = {
    cross:       '<path d="M12 2v20"/><path d="M5 9h14"/>',
    sacredHeart: '<path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/><path d="M12 5v6"/><path d="M12 5c-1 2.5 1 4 0 6"/><path d="M9 2c1 1.5 2 2 3 3 1-1 2-1.5 3-3"/>',
    chiRho:      '<path d="M12 4v18"/><path d="M12 4c3 0 6 2 6 5s-3 5-6 5"/><path d="M8 8l8 8"/><path d="M16 8l-8 8"/>',
    marian:      '<path d="M12 2l1.5 4.5L18 7l-3.5 3 1 5L12 13l-3.5 2 1-5L6 7l4.5-.5z"/><path d="M12 13v9"/><path d="M7 18c2-2 3.5-3 5-5 1.5 2 3 3 5 5"/>',
